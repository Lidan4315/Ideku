...
namespace Ideku.Services.Notification
{
    public interface INotificationService
    {
        ...
        Task NotifyIdeaApproved(Models.Entities.Idea idea, User approver, List<User>? workstreamLeaders = null);
        Task NotifyIdeaRejected(Models.Entities.Idea idea, User rejector, string reason, List<User>? workstreamLeaders = null);
